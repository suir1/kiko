...
int main() {
...

  {
    ...
    snap.profile.last_path = "direct";
    snap.profile.success_count = 3;
    snap.profile.outbound_history.path = "physical";
    snap.profile.outbound_history.bind_interface = "en0";
    snap.profile.outbound_history.reason = "physical_lower_rtt";
    snap.profile.outbound_history.rtt_by_path["default"] = 90;
    snap.profile.outbound_history.rtt_by_path["physical"] = 42;
    snap.profile.last_direct_candidate_kind = "lan";
    snap.profile.last_direct_rtt_ms = 4;
    snap.profile.candidate_failures_by_kind["public"] = 2;
