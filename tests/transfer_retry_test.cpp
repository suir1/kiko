...
int main() {
  const std::vector<Case> cases = {
      ...
      {"failed to write received file: payload.bin", false},
      {"failed to flush received file: payload.bin", false},
      {"failed to close received file: payload.bin", false},
      {"received file size mismatch for payload.bin", false},
      {"failed to inspect free space for receive directory", false},
      {"not enough free space to receive files", false},
